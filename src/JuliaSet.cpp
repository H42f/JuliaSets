...
std::complex<double> square (std::complex<double> &z, const std::complex<double> &c) {
    return std::pow(z, 2) + c;
}
std::complex<double> cube (std::complex<double> &z, const std::complex<double> &c) {
    return std::pow(z, 3) + c;
}
std::complex<double> quartic (std::complex<double> &z, const std::complex<double> &c) {
...
int main(int argc, char *argv[]) {
    ...
    binary_file = argv[3];
    int power = std::stoi(binary_file);
    binary_file = argv[4];
    ...
    std::complex<double> (*function)(std::complex<double>&, const std::complex<double>&);
    switch(power) {
        case 2:
            function = &square;
            break;
        ...
        case 4:
            ...
            break;
        default:
            std::cerr << "Power argument could not associated to any valid function :(" << std::endl;
            return 1;
    }
